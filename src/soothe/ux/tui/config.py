...
def _ensure_bootstrap() -> None:
    ...
    with _bootstrap_lock:
        ...
        try:
            from soothe.ux.tui.project_utils import (
...
class Settings:
    ...
    def from_environment(cls, *, start_path: Path | None = None) -> Settings:
        ...
        from soothe.ux.tui._env_vars import (
            EXTRA_SKILLS_DIRS,
            LANGSMITH_PROJECT,
            SHELL_ALLOW_LIST,
        )
        ...
        # Detect project
        from soothe.ux.tui.project_utils import find_project_root
    ...
    def get_project_agent_md_path(self) -> list[Path]:
        ...
        if not self.project_root:
            return []
        from soothe.ux.tui.project_utils import find_project_agent_md
...
def _get_default_model_spec() -> str:
    ...
    """
    from soothe.ux.tui.model_config import ModelConfig, ModelConfigError
...
def _get_provider_kwargs(provider: str, *, model_name: str | None = None) -> dict[str, Any]:
    ...
    """
    from soothe.ux.tui.model_config import ModelConfig
    ...
    from soothe.ux.tui.model_config import PROVIDER_API_KEY_ENV, resolve_env_var
...
def _create_model_from_class(
    ...
    from soothe.ux.tui.model_config import ModelConfigError
...
def _apply_profile_overrides(
    ...
    *,
    ...
    try:
        ...
        if raise_on_failure:
            msg = (
                f"Could not apply {label} to model '{model_name}': {exc}. The model may not support profile assignment."
            )
