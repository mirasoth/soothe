...
from soothe.ux.tui import theme
from soothe.ux.tui._cli_context import CLIContext
from soothe.ux.tui._session_stats import (
    SessionStats,
    SpinnerStatus,
    format_token_count,
)
...
from soothe.ux.tui._version import CHANGELOG_URL, DOCS_URL
from soothe.ux.tui.config import is_ascii_mode
from soothe.ux.tui.widgets.chat_input import ChatInput
from soothe.ux.tui.widgets.loading import LoadingWidget
from soothe.ux.tui.widgets.message_store import (
    MessageData,
    MessageStore,
    MessageType,
    ToolStatus,
)
from soothe.ux.tui.widgets.messages import (
    AppMessage,
    AssistantMessage,
    ErrorMessage,
    QueuedUserMessage,
...
from soothe.ux.tui.widgets.welcome import WelcomeBanner
...
if TYPE_CHECKING:
    ...
    from soothe.ux.tui._ask_user_types import AskUserWidgetResult, Question
    from soothe.ux.tui.mcp_tools import MCPServerInfo
    from soothe.ux.tui.remote_client import RemoteAgent
    from soothe.ux.tui.server import ServerProcess
    from soothe.ux.tui.skills.load import ExtendedSkillMetadata
    from soothe.ux.tui.textual_adapter import TextualUIAdapter
    from soothe.ux.tui.widgets.approval import ApprovalMenu
    from soothe.ux.tui.widgets.ask_user import AskUserMenu
...
_IS_ITERM = (
    (os.environ.get("LC_TERMINAL", "") == "iTerm2" or os.environ.get("TERM_PROGRAM", "") == "iTerm.app")
...
def _new_thread_id() -> str:
    ...
    Returns:
        UUID7 string.
    """
    from soothe.ux.tui.sessions import generate_thread_id
...
class SootheApp(App):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        from soothe.ux.tui.input import MediaTracker
    ...
    async def _check_optional_tools_background(self) -> None:
        ...
        try:
            from soothe.ux.tui.main import (
    ...
    def _discover_skills_and_roots(
        ...
        """
        from soothe.ux.tui.skills.invocation import discover_skills_and_roots
    ...
    async def _resolve_resume_thread(self) -> None:
        ...
        """
        from soothe.ux.tui.sessions import (
    ...
    async def _start_server_background(self) -> None:
        ...
        if self._model_kwargs is not None:
            from soothe.ux.tui.config import create_model
            from soothe.ux.tui.model_config import ModelConfigError, save_recent_model
        ...
        from soothe.ux.tui.server_manager import start_server_and_get_agent
        ...
        if self._mcp_preload_kwargs is not None:
            from soothe.ux.tui.main import _preload_session_mcp_server_info
    ...
    def _prewarm_deferred_imports() -> None:
        ...
        from soothe.ux.tui.config import settings  # noqa: F401
        from soothe.ux.tui.hooks import dispatch_hook  # noqa: F401
        from soothe.ux.tui.model_config import ModelSpec  # noqa: F401
        from soothe.ux.tui.textual_adapter import TextualUIAdapter  # noqa: F401
        from soothe.ux.tui.update_check import is_update_check_enabled  # noqa: F401
        ...
        from soothe.ux.tui.widgets.approval import ApprovalMenu  # noqa: F401
        from soothe.ux.tui.widgets.ask_user import AskUserMenu  # noqa: F401
        from soothe.ux.tui.widgets.model_selector import (
            ModelSelectorScreen,  # noqa: F401
        )
        from soothe.ux.tui.widgets.thread_selector import (  # noqa: F401
    ...
    async def _check_for_updates(self) -> None:
        ...
        try:
            from soothe.ux.tui.update_check import (
        ...
        try:
            from soothe.ux.tui._version import __version__ as cli_version

            if is_auto_update_enabled():
                from soothe.ux.tui.update_check import perform_upgrade
    ...
    async def _show_whats_new(self) -> None:
        ...
        try:
            from soothe.ux.tui.update_check import should_show_whats_new
        ...
        try:
            from soothe.ux.tui._version import __version__ as cli_version
            from soothe.ux.tui.config import _is_editable_install
        ...
        try:
            from soothe.ux.tui._version import __version__ as cli_version
            from soothe.ux.tui.update_check import mark_version_seen
    ...
    async def _request_approval(
        ...
        """
        from soothe.ux.tui.config import (
            SHELL_TOOL_NAMES,
    ...
    async def on_chat_input_submitted(self, event: ChatInput.Submitted) -> None:
        ...
        from soothe.ux.tui.hooks import dispatch_hook

        await dispatch_hook("user.prompt", {})

        # /quit and /q always execute immediately, even mid-thread-switch.
        from soothe.ux.tui.command_registry import ALWAYS_IMMEDIATE
    ...
    async def _build_thread_message(prefix: str, thread_id: str) -> str | Content:
        ...
        """
        from soothe.ux.tui.config import build_langsmith_thread_url
    ...
    async def _handle_command(self, command: str) -> None:
        ...
        """
        from soothe.ux.tui.config import newline_shortcut, settings
        ...
        if cmd in {"/quit", "/q"}:
            ...
            try:
                from soothe.ux.tui._version import (
            ...
            try:
                ...
                from soothe.ux.tui.model_config import clear_caches
    ...
    async def _invoke_skill(
        ...
        *,
        ...
        """
        from soothe.ux.tui.skills.invocation import build_skill_invocation_envelope
        from soothe.ux.tui.skills.load import load_skill_content
    ...
    async def _handle_offload(self) -> None:
        ...
        try:
            ...
            from soothe.ux.tui.textual_adapter import _persist_context_tokens
    ...
    async def _run_agent_task(
        ...
        *,
        ...
        if self._ui_adapter is None:
            return
        from soothe.ux.tui.textual_adapter import execute_task_textual
    ...
    async def _read_channel_values_from_checkpointer(thread_id: str) -> dict[str, Any]:
        ...
        try:
            ...
            from soothe.ux.tui.sessions import get_db_path
    ...
    def action_quit_app(self) -> None:
        ...
        from soothe.ux.tui.widgets.thread_selector import (
            DeleteThreadConfirmScreen,
            ThreadSelectorScreen,
        )
    ...
    def exit(
        ...
        from soothe.ux.tui.hooks import _dispatch_hook_sync, _load_hooks
    ...
    async def _show_theme_selector(self) -> None:
        ...
        from soothe.ux.tui.widgets.theme_selector import ThemeSelectorScreen
    ...
    async def _show_notification_settings(self) -> None:
        ...
        from soothe.ux.tui.model_config import is_warning_suppressed
        from soothe.ux.tui.widgets.notification_settings import (
            WARNING_TOGGLES,
    ...
    async def _show_thread_selector(self) -> None:
        ...
        from soothe.ux.tui.sessions import get_cached_threads, get_thread_limit
        from soothe.ux.tui.widgets.thread_selector import ThreadSelectorScreen
    ...
    async def _switch_model(
        ...
        *,
        ...
        Args:
            ...
            extra_kwargs: Extra constructor kwargs from `--model-params`.
        """
        from soothe.ux.tui.config import create_model, detect_provider, settings
        from soothe.ux.tui.model_config import (
            ModelSpec,
    ...
    async def _clear_default_model(self) -> None:
        ...
        """
        from soothe.ux.tui.model_config import clear_default_model

        if await asyncio.to_thread(clear_default_model):
            await self._mount_message(
                AppMessage("Default model cleared. Future launches will use recent model or auto-detect.")
            )
        else:
            await self._mount_message(
