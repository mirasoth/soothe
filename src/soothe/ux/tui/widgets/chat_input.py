...
from soothe.ux.tui.input import IMAGE_PLACEHOLDER_PATTERN, VIDEO_PLACEHOLDER_PATTERN
from soothe.ux.tui.widgets.autocomplete import (
    CompletionResult,
    FuzzyFileController,
    MultiCompletionManager,
    SlashCommandController,
)
from soothe.ux.tui.widgets.history import HistoryManager
...
if TYPE_CHECKING:
    ...
    from soothe.ux.tui.input import MediaTracker, ParsedPastedPathPayload
...
class ChatTextArea(TextArea):
    ...
    async def _flush_paste_burst(self) -> None:
        ...
        from soothe.ux.tui.input import parse_pasted_path_payload
...
class ChatInput(Vertical):
    ...
    def _extract_leading_dropped_path_with_command_recovery(self, text: str) -> tuple[str, tuple[Path, int] | None]:
        ...
        """
        from soothe.ux.tui.input import extract_leading_pasted_file_path
    ...
    def _build_path_replacement(
        ...
        *,
        ...
        from soothe.ux.tui.media_utils import (
            IMAGE_EXTENSIONS,
            MAX_MEDIA_BYTES,
            VIDEO_EXTENSIONS,
            ImageData,
