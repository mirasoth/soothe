...
if TYPE_CHECKING:
    ...
    from soothe.ux.tui.sessions import ThreadInfo
...
from soothe.ux.tui.widgets._links import open_style_link
...
class ThreadSelectorScreen(ModalScreen[str | None]):
    ...
    def __init__(
        ...
        *,
        ...
        from soothe.ux.tui.model_config import load_thread_config
    ...
    def _effective_thread_limit(self) -> int:
        ...
        from soothe.ux.tui.sessions import get_thread_limit
    ...
    def on_checkbox_changed(self, event: Checkbox.Changed) -> None:
        ...
        if event.checkbox.id == _RELATIVE_TIME_SWITCH_ID:
            ...
            from soothe.ux.tui.model_config import save_thread_relative_time
        ...
        from soothe.ux.tui.model_config import save_thread_columns
    ...
    async def _populate_visible_checkpoint_details(self) -> tuple[bool, bool]:
        ...
        """
        from soothe.ux.tui.sessions import populate_thread_checkpoint_details
    ...
    def _persist_sort_order(self, order: str) -> None:
        ...
        async def _save() -> None:
            from soothe.ux.tui.model_config import save_thread_sort_order
    ...
    async def _handle_delete_confirm(self, thread_id: str) -> None:
        ...
        """
        from soothe.ux.tui.sessions import delete_thread
