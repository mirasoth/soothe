...
from soothe.ux.tui.config import get_glyphs, is_ascii_mode
...
class ThemeSelectorScreen(ModalScreen[str | None]):
    ...
    def compose(self) -> ComposeResult:
        ...
        with Vertical():
            ...
            yield option_list
            help_text = (
                f"{glyphs.arrow_up}/{glyphs.arrow_down} preview {glyphs.bullet} Enter select {glyphs.bullet} Esc cancel"
            )
