...
Record character's basic personal information only (age, location, background, etc.)
- NO EVENTS.
"""
...
class ProfileConfig:
    ...
    description: str = (
        "Record character's basic personal information only "
        "(age, location, background, demographics) - excludes events and activities"
    )
...
def get_file_info() -> dict[str, str | int]:
