...
def _check_inmemory_vectorstore() -> CheckResult:
    ...
    try:
        from soothe_daemon.backends.vector_store.in_memory import InMemoryVectorStore  # noqa: F401
...
def _check_pgvector(config: SootheConfig | None) -> CheckResult:
    ...
    # Try to import
    try:
        from soothe_daemon.backends.vector_store.pgvector import PGVectorStore  # noqa: F401
...
def _check_weaviate(config: SootheConfig | None) -> CheckResult:
    ...
    # Try to import
    try:
        from soothe_daemon.backends.vector_store.weaviate import WeaviateVectorStore  # noqa: F401
