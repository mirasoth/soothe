...
from soothe_daemon.daemon.health.models import CategoryResult, CheckStatus, HealthReport
...
class HealthChecker:
    ...
    async def check_config(self) -> CategoryResult:
        ...
        """
        from soothe_daemon.daemon.health.checks.config_check import check_config
    ...
    async def check_daemon(self) -> CategoryResult:
        ...
        """
        from soothe_daemon.daemon.health.checks.daemon_check import check_daemon
    ...
    async def check_persistence(self) -> CategoryResult:
        ...
        """
        from soothe_daemon.daemon.health.checks.persistence_check import check_persistence
    ...
    async def check_protocols(self) -> CategoryResult:
        ...
        """
        from soothe_daemon.daemon.health.checks.protocols_check import check_protocols
    ...
    async def check_vector_stores(self) -> CategoryResult:
        ...
        """
        from soothe_daemon.daemon.health.checks.vector_stores_check import check_vector_stores
    ...
    async def check_providers(self) -> CategoryResult:
        ...
        """
        from soothe_daemon.daemon.health.checks.providers_check import check_providers
    ...
    async def check_mcp_servers(self) -> CategoryResult:
        ...
        """
        from soothe_daemon.daemon.health.checks.mcp_check import check_mcp_servers
    ...
    async def check_external_apis(self) -> CategoryResult:
        ...
        """
        from soothe_daemon.daemon.health.checks.external_apis_check import check_external_apis
    ...
    async def check_observability(self) -> CategoryResult:
        ...
        """
        from soothe_daemon.daemon.health.checks.observability_check import check_observability
