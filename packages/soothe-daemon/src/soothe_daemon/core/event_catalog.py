...
For type-safe event emission (recommended):
    from soothe_daemon.core.event_catalog import ThreadCreatedEvent, PlanStepStartedEvent
    yield custom_event(ThreadCreatedEvent(thread_id=tid).to_dict())

For event type string constants:
    from soothe_daemon.core.event_catalog import THREAD_CREATED, PLAN_STEP_STARTED
...
def register_event(
    ...
    **Usage**:
    ...
    ```python
    from soothe_daemon.core.event_catalog import register_event
