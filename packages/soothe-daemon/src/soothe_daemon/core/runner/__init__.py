...
from soothe_daemon.protocols.planner import Plan, PlannerProtocol
...
class SootheRunner(CheckpointMixin, StepLoopMixin, AutonomousMixin, AgenticMixin, PhasesMixin):
    ...
    def __init__(self, config: SootheConfig | None = None) -> None:
        ...
        from soothe_daemon.core.concurrency import ConcurrencyController
        from soothe_daemon.core.resolver import (
            resolve_checkpointer,
            resolve_durability,
            resolve_goal_engine,
        )
        from soothe_daemon.core.unified_classifier import UnifiedClassifier
        ...
        if self._config.performance.enabled and self._config.performance.unified_classification:
            ...
            if fast_model:
                ...
                logger.info(
                    "Unified classifier initialized in %s mode",
    ...
    async def touch_thread_activity_timestamp(self, thread_id: str) -> None:
        ...
        try:
            ...
            if thread_data:
                from soothe_daemon.protocols.durability import ThreadInfo
