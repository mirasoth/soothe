...
from soothe_daemon.core.event_catalog import CheckpointSavedEvent, RecoveryResumedEvent
...
if TYPE_CHECKING:
    ...
    from soothe_daemon.core.artifact_store import RunArtifactStore
...
class CheckpointMixin:
    ...
    def _ensure_artifact_store(self, state: Any) -> RunArtifactStore | None:
        ...
        from soothe_daemon.core.artifact_store import RunArtifactStore
        from soothe_daemon.utils.runtime import current_run_dir
