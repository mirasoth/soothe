...
if TYPE_CHECKING:
    ...
    from soothe_daemon.protocols.planner import PlanContext
...
class PromptBuilder:
    ...
    def _build_system_message(
        ...
        if self.config is not None:
            from soothe_daemon.core.prompts.context_xml import (
            ...
            from soothe_daemon.core.prompts.context_xml import build_soothe_workspace_section
