...
if TYPE_CHECKING:
    ...
    from soothe_daemon.core.tool_context_registry import ToolContextRegistry
    from soothe_daemon.core.tool_trigger_registry import ToolTriggerRegistry
...
class SystemPromptOptimizationMiddleware(AgentMiddleware):
    ...
    def _build_environment_section(self) -> str:
        ...
        """
        from soothe_daemon.core.prompts.context_xml import build_soothe_environment_section
    ...
    def _get_prompt_for_complexity(
        ...
        """
        from soothe_daemon.core.prompts.context_xml import build_context_sections_for_complexity
