"""Planning utilities for agent loop.

Consolidates plan parsing, reflection logic, and JSON parsing utilities
for LLM response handling.
"""
...
# ============================================================================
# JSON Parsing Utilities (moved from llm.py)
# ============================================================================
...
# ============================================================================
# Agent Decision Parsing Utilities (moved from llm.py)
# ============================================================================
...
def _align_step_descriptions(goal: str, steps: list[Any]) -> None:
    ...
    from soothe_daemon.cognition.agent_loop.schemas import StepAction
...
def agent_decision_from_dict(data: dict[str, Any], _goal: str) -> Any:
    ...
    from soothe_daemon.cognition.agent_loop.schemas import AgentDecision, StepAction
