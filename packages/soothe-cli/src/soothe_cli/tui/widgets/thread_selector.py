...
if TYPE_CHECKING:
    ...
    from soothe_cli.tui.sessions import ThreadInfo
...
class ThreadSelectorScreen(ModalScreen[str | None]):
    ...
    def on_checkbox_changed(self, event: Checkbox.Changed) -> None:
        ...
        if event.checkbox.id == _RELATIVE_TIME_SWITCH_ID:
            ...
            from soothe_cli.tui.model_config import save_thread_relative_time
        ...
        from soothe_cli.tui.model_config import save_thread_columns
    ...
    def _compute_column_widths(self) -> dict[str, int | None]:
        ...
        fingerprint = tuple(
            (t["thread_id"], t.get("latest_checkpoint_id")) for t in self._filtered_threads
        )
    ...
    async def _populate_visible_checkpoint_details(self) -> tuple[bool, bool]:
        ...
        """
        from soothe_cli.tui.sessions import populate_thread_checkpoint_details
    ...
    def _persist_sort_order(self, order: str) -> None:
        ...
        async def _save() -> None:
            from soothe_cli.tui.model_config import save_thread_sort_order
    ...
    async def _handle_delete_confirm(self, thread_id: str) -> None:
        ...
        """
        from soothe_cli.tui.sessions import delete_thread
